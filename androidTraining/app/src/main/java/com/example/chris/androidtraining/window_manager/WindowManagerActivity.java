...
public class WindowManagerActivity extends AppCompatActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(activityClass.getActivityClass() == null) {
                    Toast.makeText(WindowManagerActivity.this, "没有实现", Toast.LENGTH_SHORT).show();
                }else {
                    Intent intent = new Intent(WindowManagerActivity.this, activityClass.getActivityClass());
    ...
    private void initData() {
        activityClassList.add(new ActivityClass("View Life Cycle", ViewLifeCycleActivity.class));
