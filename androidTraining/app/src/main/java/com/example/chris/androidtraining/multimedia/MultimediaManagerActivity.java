...
public class MultimediaManagerActivity extends AppCompatActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(activityClass.getActivityClass() == null) {
                    Toast.makeText(MultimediaManagerActivity.this, "没有实现", Toast.LENGTH_SHORT).show();
                }else {
                    Intent intent = new Intent(MultimediaManagerActivity.this, activityClass.getActivityClass());
    ...
    private void initData() {
        activityClassList.add(new ActivityClass("Capturing Photos", CapturingPhotosManagerActivity.class));
        activityClassList.add(new ActivityClass("Printing Content", null));
    }
}
