...
public class IntentManagerActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        activityClassList.add(new ActivityClass("Getting a Result from an Activity", null));
        activityClassList.add(new ActivityClass("Allowing Other Apps to Start Your Activity", null));
    }
}
